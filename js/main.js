...
mapPinMain.addEventListener('mousedown', function (evt) { /* Добавлен слушатель/обработчик на событие mousedown */
  if (evt.which == 1) {
    mapPinMainActions();
  }
});
...
mapPinMain.addEventListener('keydown', function (evt) { /* Добавлен слушатель/обработчик на событие mousedown */
  if (evt.key == 'Enter') {
